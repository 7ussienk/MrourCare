...
namespace WebApplication3
{
    public partial class RenewLicense : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string script = @"<script>Swal.fire({ title: 'تجديد رخصة' });</script>";
        ...
        protected void Sendbtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //RenewLiecen
                string insertQuery5 = "INSERT INTO Licen_Renew (Name, Old_license, Birth_day, Birth_place, Age, Job,Status,DateofSend,TypeofRequest,IPofBook,Oldlicexp,Oldlicepr,Center,Address_ip,Identity_ip, Emailofuser) " +
                                      "VALUES (@Name, @Old_license, @Birth_day, @Birth_place, @Age, @Job, @Status, @DateofSend, @TypeofRequest, @IPofBook, @Oldlicexp, @Oldlicepr,@Center," +
                ...
                insertCommand5.Parameters.AddWithValue("@Old_license", LicNum.Text);
                ...
                insertCommand5.Parameters.AddWithValue("@TypeofRequest", "تجديد رخصة");
                insertCommand5.Parameters.AddWithValue("@IPofBook", "0");
                insertCommand5.Parameters.AddWithValue("@Oldlicexp", oldlicexp.Text);
                insertCommand5.Parameters.AddWithValue("@Oldlicepr", oldlicepr.Text);
                insertCommand5.Parameters.AddWithValue("@Center", center.Text);
                ...
                sqlConnection.Close();
                PassPage(ownerID.ToString(), "تجديد رخصة", "uploadocs.aspx");
            }
            catch (Exception ex)
            {
