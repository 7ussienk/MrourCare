...
XML attributes:
templater-xml - to specify combine kind (merge-xml, replace-xml, remove-old-xml)
templater-cell-style - copy cell style from another cell
templater-row-style - copy row style from another row
templater-row-height - specify row height
templater-row-custom-height - specify custom row height
templater-row-collapsed - specify row collapsed attribute
templater-row-custom-format - specify row custom formatting
templater-row-hidden - specify row hidden attribute
templater-row-thick-bottom - specify row thick bottom style
templater-row-thick-top - specify row think top style
